...
class LDETSmoothScroll : public QObject
{
    Q_OBJECT

public:
    explicit LDETSmoothScroll(QAbstractScrollArea *scrollArea, QObject *parent = nullptr);

    /// @brief 便捷方法：创建并安装到目标滚动区域的 viewport
    static LDETSmoothScroll* install(QAbstractScrollArea *scrollArea,
