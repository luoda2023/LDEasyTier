...
class LDETTabWidget : public QTabWidget
{
    Q_OBJECT

public:
    explicit LDETTabWidget(QWidget *parent = nullptr);
    ~LDETTabWidget() override;
...
/// @brief 自定义 TabBar 控件
class LDETTabBar : public QTabBar
{
    Q_OBJECT
...
public:
    explicit LDETTabBar(QWidget *parent = nullptr);
    ~LDETTabBar() override;
