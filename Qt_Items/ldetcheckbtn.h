...
class LDETCheckBtn : public QCheckBox
{
    Q_OBJECT
...
public:
    explicit LDETCheckBtn(QWidget *parent = nullptr);
    explicit LDETCheckBtn(const QString &text, QWidget *parent = nullptr);
    ~LDETCheckBtn() override;
