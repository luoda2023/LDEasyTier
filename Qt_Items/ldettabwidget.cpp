...
LDETTabWidget::LDETTabWidget(QWidget *parent)
    : QTabWidget(parent)
{
    init();
}

LDETTabWidget::~LDETTabWidget() = default;

void LDETTabWidget::init()
{
    m_tabBar = new LDETTabBar(this);
    setTabBar(m_tabBar);
...
void LDETTabWidget::updateColorScheme()
{
...
void LDETTabWidget::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event)
...
LDETTabBar::LDETTabBar(QWidget *parent)
    : QTabBar(parent)
...
void LDETTabBar::updateColorScheme()
{
    auto *theme = LDETTheme::instance();
...
qreal LDETTabBar::indicatorWidth() const { return m_indicatorWidth; }
void LDETTabBar::setIndicatorWidth(qreal width)
{
...
qreal LDETTabBar::indicatorX() const { return m_indicatorX; }
void LDETTabBar::setIndicatorX(qreal x)
{
...
qreal LDETTabBar::hoverOpacity() const { return m_hoverOpacity; }
void LDETTabBar::setHoverOpacity(qreal opacity)
{
...
QSize LDETTabBar::sizeHint() const
{
    int totalWidth = 0;
...
void LDETTabBar::recalculateTabWidths()
{
...
QRect LDETTabBar::calculateTabRect(int index) const
{
    ...
    if (m_tabTextWidths.size() != count()) {
        const_cast<LDETTabBar*>(this)->recalculateTabWidths();
    }
...
int LDETTabBar::getTabTextWidth(int index) const
{
    if (index < 0 || index >= count()) {
        return 0;
    }
...
void LDETTabBar::animateIndicatorTo(int index)
{
    if (index < 0 || index >= count()) {
        return;
    }
...
void LDETTabBar::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event)
...
void LDETTabBar::resizeEvent(QResizeEvent *event)
{
...
void LDETTabBar::mousePressEvent(QMouseEvent *event)
{
...
void LDETTabBar::mouseMoveEvent(QMouseEvent *event)
{
...
void LDETTabBar::leaveEvent(QEvent *event)
{
    m_hoveredTabIndex = -1;
    update();
...
void LDETTabBar::keyPressEvent(QKeyEvent *event)
{
...
bool LDETTabBar::event(QEvent *event)
{
