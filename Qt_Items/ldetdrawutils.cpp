...
QColor LDETDrawUtils::blendColors(const QColor &from, const QColor &to, qreal opacity)
{
...
void LDETDrawUtils::drawRoundedRect(QPainter *painter, const QRect &rect, int radius,
...
void LDETDrawUtils::drawRoundedFill(QPainter *painter, const QRect &rect, int radius,
...
void LDETDrawUtils::drawBottomIndicator(QPainter *painter, qreal x, qreal y,
...
void LDETDrawUtils::drawLabel(QPainter *painter, int x, int y,
...
QSize LDETDrawUtils::labelSize(const QString &text, int fontSize,
...
void LDETDrawUtils::safeEndPainter(QPainter *painter)
{
    if (painter->isActive()) {
        painter->end();
    }
...
LDETSmoothScroll::LDETSmoothScroll(QAbstractScrollArea *scrollArea, QObject *parent)
    : QObject(parent)
    , m_scrollArea(scrollArea)
{
}

LDETSmoothScroll* LDETSmoothScroll::install(QAbstractScrollArea *scrollArea,
                                             int duration, int step)
{
    auto *filter = new LDETSmoothScroll(scrollArea, scrollArea);
...
void LDETSmoothScroll::setDuration(int ms)
{
    m_duration = ms;
}

void LDETSmoothScroll::setScrollStep(int step)
{
    m_scrollStep = step;
}

bool LDETSmoothScroll::eventFilter(QObject *watched, QEvent *event)
{
