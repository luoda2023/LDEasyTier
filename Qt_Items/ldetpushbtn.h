...
class LDETPushBtn : public QPushButton
{
    Q_OBJECT
    Q_PROPERTY(qreal borderOpacity READ borderOpacity WRITE setBorderOpacity)

public:
    explicit LDETPushBtn(QWidget *parent = nullptr);
    explicit LDETPushBtn(const QString &text, QWidget *parent = nullptr);
    ~LDETPushBtn() override;
