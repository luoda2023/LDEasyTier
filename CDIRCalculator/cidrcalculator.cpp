...
void CIDRCalculator::setupUI()
{
    ...
    cidrInput = new LDETLineEdit();
    cidrInput->setPlaceholderText("例如: 192.168.1.0/24");
    cidrCalculateBtn = new LDETPushBtn("计算");
    ...
    rangeStartInput = new LDETLineEdit();
    ...
    cidrResultsOutput = new LDETLineEdit();
    cidrResultsOutput->setReadOnly(true);
    // 不设置border，让LDETLineEdit自定义绘制处理边框
    ...
    copyCIDRBtn = new LDETPushBtn("复制CIDR");
