...
#define ProjectDir "E:\YMHuang\Programs_Code\CPP_Qt\LDEasyTier"
...
OutputBaseFilename=LDEasyTier_v{#MyAppVersion}_win_amd64_installer
...
begin
  ...
  begin
    ...
    ConfigPath := ExpandConstant('{localappdata}\LDEasyTier');

    // 检查配置文件夹是否存在
    if DirExists(ConfigPath) then
    begin
      // 弹出询问对话框
      if MsgBox('是否删除 LDEasyTier 的配置文件？' + #13#10 + #13#10 +
